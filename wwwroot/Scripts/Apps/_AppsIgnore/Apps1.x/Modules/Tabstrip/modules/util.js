define({
    ...
    LoadTemplate: function (templateFileUrl, templateId, destinationElementId, callback) {

        $.ajax({
            url: templateFileUrl, type: 'get', datatype: 'html', async: false,
            success: function (data) {
                callback(false, data, templateId, destinationElementId);
            },
            error: function (data) {
                callback(true, data, templateId, destinationElementId);
            },
        });
